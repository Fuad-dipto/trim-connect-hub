        ...
        <div className="rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 p-6 shadow-2xl">
          {stage === "intro" ? (
            <>
              ...
              <h1 className="text-2xl font-bold text-center">Find salons & barbers near you</h1>
              ...
              <ul className="mt-6 space-y-3 text-sm">
                <li className="flex gap-3"><Navigation className="h-5 w-5 shrink-0" /> Auto-detect nearby salons</li>
                <li className="flex gap-3"><Sparkles className="h-5 w-5 shrink-0" /> Live crowd & queue updates</li>
                <li className="flex gap-3"><ShieldCheck className="h-5 w-5 shrink-0" /> Your location stays private</li>
              </ul>
            ...
            <div className="py-10 text-center">
              ...
              <p className="text-sm text-white/80 mt-1">Finding salons near Gulshan 2</p>
            </div>
          )}
        </div>

        <p className="text-center text-xs text-white/70 mt-6">By continuing you agree to TrimGo's Terms & Privacy</p>
      </div>
    </div>
  );
}
